...
Check for Categorical Variables and print their Summaries.
```{r}
...
Check the dimensions of the split dataset.
```{r}
...
Create x for predictor variables and y for response variables.
```{r}
...
Load e1071 Naive Bayes package
```{r}
...
Check for the stucture of the dataframe
```{r}
head(df)
...
Check for NA and get the data summary
```{r}
